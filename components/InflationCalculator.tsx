...
const InflationCalculator: React.FC = () => {
    ...
    const calculate = () => {
        ...
        setResults([
            { label: t('futureCost'), value: formatCurrency(futureValue, language, currency.code) },
            { label: t('purchasingPowerLost'), value: formatCurrency(lostValue, language, currency.code) },
        ]);
    };
